...
public class ShiprsCodegen extends RustServerCodegen {
    private static final Logger LOGGER = LoggerFactory.getLogger(ShiprsCodegen.class);

    public ShiprsCodegen() {
        super();
        typeMapping.put("DateTime", "ShiprsDate");
    }
    ...
    public Map<String, Object> postProcessAllModels(Map<String, Object> objs) {
        ...
        for (Entry<String, CodegenModel> entry : allModels.entrySet()) {
            ...
            for (CodegenProperty prop : model.vars) {
                ...
                if (prop.dataFormat != null && (prop.dataFormat.equals("dateTime") || prop.datatype.equals("ShiprsDate"))) {
                    // set DateTime format on properties where appropriate
                    prop.vendorExtensions.put("x-rustgen-is-datetime", true);
                    prop.datatype = "ShiprsDate";
                }
                if (prop.isEnum) {
