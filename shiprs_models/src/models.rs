...
#[cfg(feature = "time")]
pub type ShiprsDate = time::OffsetDateTime;
#[cfg(all(feature = "chrono", not(feature = "time")))]
pub type ShiprsDate = chrono::DateTime<chrono::Utc>;
#[cfg(not(any(feature = "chrono", feature = "time")))]
pub type ShiprsDate = String;

#[cfg(feature = "time")]
fn deserialize_timestamp<'de, D: Deserializer<'de>>(
    d: D
) -> Result<Option<ShiprsDate>, D::Error> {
...
#[cfg(feature = "time")]
fn serialize_timestamp<S: Serializer>(date: &Option<ShiprsDate>, s: S) -> Result<S::Ok, S::Error> {
    match date {
...
pub struct BuildCache {
    ...
    pub created_at: Option<ShiprsDate>,
    ...
    pub last_used_at: Option<ShiprsDate>,
...
pub struct ClusterInfo {
    ...
    pub updated_at: Option<ShiprsDate>,
...
pub struct ImageInspectMetadata {
    ...
    pub last_tag_time: Option<ShiprsDate>,
...
pub struct ServiceJobStatus {
    ...
    pub last_execution: Option<ShiprsDate>,
...
pub struct ServiceUpdateStatus {
    ...
    pub started_at: Option<ShiprsDate>,
    ...
    pub completed_at: Option<ShiprsDate>,
...
pub struct TaskStatus {
    ...
    pub timestamp: Option<ShiprsDate>,
